...
import { trackResumeConfirmationView } from '@/lib/analytics'
import { useUtmTracker } from '@/hooks/useUtmTracker'

interface ResumeSuccessContentProps {
  maskedEmail: string | null
}

export default function ResumeSuccessContent({ maskedEmail }: ResumeSuccessContentProps) {
  const pathname = usePathname()
  const { utmParams } = useUtmTracker()

  // Track confirmation view on mount
  useEffect(() => {
    trackResumeConfirmationView({
      page_path: pathname,
      ...(utmParams || {}),
    })
  }, [pathname, utmParams])
